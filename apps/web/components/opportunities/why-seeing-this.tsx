...
export function WhySeeingThis({
  ...
  return (
    <div className="rounded-xl border border-emerald-500/20 bg-emerald-950/10 p-6 shadow-sm">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
        <div className="rounded-lg border border-zinc-800/80 bg-zinc-950/60 p-3">
          ...
          <div className="flex flex-wrap gap-1">
            {matchedSkills.map((s) => (
              <span
                key={s}
                className="inline-flex items-center gap-1 rounded bg-emerald-500/10 px-2 py-0.5 text-xs font-mono text-emerald-300 border border-emerald-500/20"
              >
        ...
        <div className="rounded-lg border border-zinc-800/80 bg-zinc-950/60 p-3">
          ...
          <div className="text-xs font-mono text-zinc-300">
            Selected via <span className="text-emerald-400 font-semibold">Bid × Relevance × Quality</span>
          </div>
        </div>
      </div>
    </div>
