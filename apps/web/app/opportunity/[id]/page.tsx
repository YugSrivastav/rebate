  ...
  if (loading) {
    return (
      <div className="flex h-96 items-center justify-center font-mono text-xs text-zinc-500">
        <span className="animate-spin text-emerald-400 mr-2">⠋</span> Loading Opportunity Details...
      </div>
    );
  }
  ...
  if (!opp) {
    return (
      <div className="mx-auto max-w-xl py-24 text-center">
        ...
        <Link href="/developer" className="mt-4 inline-block text-xs text-emerald-400 hover:underline">
      ...
      <div className="rounded-xl border border-zinc-800 bg-zinc-900/40 p-6 sm:p-8 shadow-xl">
        <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-6 border-b border-zinc-800/80 pb-6">
          <div className="flex items-start gap-4">
            <div className="h-12 w-12 rounded-xl bg-gradient-to-br from-emerald-500/20 to-teal-500/10 border border-emerald-500/30 flex items-center justify-center text-emerald-400 shrink-0 font-mono font-bold text-lg">
          ...
          <div className="sm:text-right shrink-0">
            <button
              ...
              className="inline-flex items-center gap-2 rounded-lg bg-emerald-500 px-5 py-2.5 text-xs font-semibold text-black hover:bg-emerald-400 transition shadow-md shadow-emerald-500/20"
            >
