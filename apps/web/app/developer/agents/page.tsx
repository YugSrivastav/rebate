  ...
  if (isLoading) {
    return (
      <div className="flex h-96 items-center justify-center font-mono text-xs text-zinc-500">
        <span className="animate-spin text-indigo-400 mr-2">⠋</span> Loading Connected Agents...
      </div>
    );
  }
        ...
        {agents.map(([type, info]) => (
          ...
          >
            <div>
              <div className="flex items-center justify-between mb-3">
                <div className="flex items-center gap-2">
                  <div className="h-8 w-8 rounded-lg bg-zinc-900 border border-zinc-800 flex items-center justify-center text-indigo-400">
                ...
                <span className="flex items-center gap-1 text-[11px] font-mono text-indigo-400 bg-zinc-900 px-2 py-0.5 rounded border border-zinc-800">
            ...
            <div className="mt-4 pt-3 border-t border-zinc-900 text-[11px] text-zinc-500 flex items-center justify-between">
              ...
              <span className="text-indigo-400 font-mono">1-Line Hook Ready</span>
            </div>
          </div>
        ))}
      </div>
